<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="GDLC_HRApp.Login" %>
    ...
    <div class="loginColumns animated fadeInDown">
        <div class="row">
            <div class="col-md-4" style="color:black">
                <h2 class="font-bold">GDLC HR System</h2>
                ...
                <p style="font-style:italic;">
                    Task Scheduling and Document Sharing
                </p>
                <%--<p style="font-weight:bold; font-size:medium; font-style:italic;">
                    Log complaint
                </p>--%>
                <p style="font-style:italic;">
                    Electronic Appraisal Management
                </p>
                <p style="font-style:italic;">
                    Organise other HR processes
                </p>
            </div>
