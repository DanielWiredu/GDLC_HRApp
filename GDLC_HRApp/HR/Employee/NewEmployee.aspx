<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="NewEmployee.aspx.cs" Inherits="GDLC_HRApp.HR.Employee.NewEmployee" %>
...
div.upload input {
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
                    ...
                    <ContentTemplate>
                        ...
                        <div class="row">
                           ...
                           <asp:RequiredFieldValidator runat="server" ControlToValidate="dpDOB" Display="Dynamic" ErrorMessage="Required Field" SetFocusOnError="true" ForeColor="Red"></asp:RequiredFieldValidator>
                            ...
                            <input class="upload" id="avatarUpload" type="file" name="file" accept="image/*"  onchange="previewFile()"  runat="server" />
                ...
                <Tabs>
                    ...
                    <telerik:RadTab runat="server" Text="Dependents" Enabled="false">
                    </telerik:RadTab>
                    <telerik:RadTab runat="server" Text="Next of Kin" Enabled="false">
                    </telerik:RadTab>
                    <telerik:RadTab runat="server" Text="Experience" Enabled="false">
                    </telerik:RadTab>
                    <telerik:RadTab runat="server" Text="Training" Enabled="false">
                    </telerik:RadTab>
                </Tabs>
            </telerik:RadTabStrip>
                ...
                items
                    ...
                    <ContentTemplate>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button runat="server" ID="btnReturn" Text="Return" CssClass="btn btn-warning" CausesValidation="false" PostBackUrl="~/HR/Employee/Employees.aspx" />
