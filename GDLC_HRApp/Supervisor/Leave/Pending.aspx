<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Pending.aspx.cs" Inherits="GDLC_HRApp.Supervisor.Leave.Pending" %>
    ...
    <div class="wrapper wrapper-content animated fadeInRight">
                <div class="ibox float-e-margins">
                    ...
                    <ContentTemplate>
                        ...
                        <hr />
                             <telerik:RadGrid ID="leaveGrid" runat="server" DataSourceID="leaveSource" AutoGenerateColumns="False" GroupPanelPosition="Top" AllowPaging="False" AllowSorting="True" CellSpacing="-1" GridLines="Both" OnItemCommand="leaveGrid_ItemCommand">
                            <ClientSettings>
                        ...
                        <asp:SqlDataSource ID="leaveSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT Id,CreatedDate,StaffNo,EmployeeName,LeaveType,Startdate,Enddate,DaysRequested,ApprovedStatus from vwLeave WHERE SupervisorId=@SupervisorId AND ApprovedStatus = 0 AND (EmployeeName LIKE '%' + @SearchValue + '%' OR LeaveType LIKE '%' + @SearchValue + '%') ORDER BY Id DESC">
                            <SelectParameters>
        ...
        <asp:UpdatePanel runat="server">
            <ContentTemplate>
                ...
                <div class="modal-footer">
                    ...
                    <asp:Button ID="btnApprove" runat="server" Text="Approve" CssClass="btn btn-primary" OnClick="btnApprove_Click" OnClientClick="if (Page_IsValid) {this.value='Processing...';this.disabled=true; }" UseSubmitBehavior="false" />
                    <asp:Button ID="btnReject" runat="server" Text="Reject" CssClass="btn btn-danger" OnClick="btnReject_Click" OnClientClick="if (Page_IsValid) {this.value='Processing...';this.disabled=true; }" UseSubmitBehavior="false" />
                </div>
            </div>
            </ContentTemplate>
        </asp:UpdatePanel>
